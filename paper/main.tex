...
\begin{aug}
\author{\fnms{Yuriy} \snm{Mishchencko} \thanksref{t1}\ead[label=e2]{second@somewhere.com}}
\author{\fnms{Joshua T.} \snm{Vogelstein}\thanksref{t2}\ead[label=e1]{joshuav@jhu.edu}},
\and
\author{\fnms{Liam} \snm{Paninski}\thanksref{t1}
\ead[label=e3]{liam@stat.columbia.edi}

...
\subsection{Sampling individual neuron spike trains using SMC}
\label{sec:methods:smc_inference}
\input{smc_inference.tex}

\subsection{Estimating parameters for individual neurons}
\label{sec:methods:smc_learning}
\input{smc_learning.tex}

\subsection{Sampling joint spike trains using hybrid MCMC and Gibbs algorithm}

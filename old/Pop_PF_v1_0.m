function [M_best E_best] = Pop_PF_v1_0(F,P,Sim)
% this function runs SMC-EM on fluorescence time-series from a population of neurons,
% and outputs the inferred distributions and parameter estimates
%
% Inputs
% F:    fluorescence time series (Nc x T)

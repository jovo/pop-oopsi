...
% 6) plot trye and inferred omega
% 7) infer spike trains
% 8) estimate connection matrix from spike inference
% 9) plot inferrence and omega from inferrence
%
% Remarks:
...
%% 9) plot omega from inferred spikes
...
[P.omega round(Phat.omega*10)/10]
...
subplot(132), imagesc(Phat2.omega,clims), %colorbar
